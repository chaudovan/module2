...
import bai_thi.RegexData;
import bai_thi.model.GiayDangKy;
import bai_thi.model.Oto;
import bai_thi.model.PhuongTien;
import bai_thi.model.XeTai;
import bai_thi.until.ReadAndWriteGiayDangKy;
import bai_thi.until.ReadFileOto;
import bai_thi.until.ReadFilePhuongTien;
import bai_thi.until.ReadFileXeTai;
...
public class PhuongTienService {
    ...
    String giayDangKyUrl = "D:\\codegym\\module2\\introduction\\src\\bai_thi\\gdkpt.csv";
    private static List<PhuongTien> phuongTienList = ReadFilePhuongTien.readFilePhuongTien("D:\\codegym\\module2\\introduction\\src\\bai_thi\\phuongTien.csv");
    private static List<Oto> oToList = ReadFileOto.readFileOTo("D:\\codegym\\module2\\introduction\\src\\bai_thi\\phuongTien.csv");
    private static List<XeTai> xeTaiList = ReadFileXeTai.readFileXeTai("D:\\codegym\\module2\\introduction\\src\\bai_thi\\phuongTien.csv");
    private static List<GiayDangKy> giayDangKyList = ReadAndWriteGiayDangKy.readFile("D:\\codegym\\module2\\introduction\\src\\bai_thi\\gdkpt.csv");
    ...
    public String dangKyOTo() {
        ...
        try {
            ...
            ReadAndWriteGiayDangKy.writeFileAccount(giayDangKyList, giayDangKyUrl);
        } catch (Exception e) {
